...
downloadButton("download_esslike_plot", "Télécharger en SVG")
downloadButton("download_esslike_plot_png", "Télécharger en PNG")
downloadButton("download_esslike_plot_tif", "Télécharger en TIF")
```
...
downloadButton("download_esslike_table", "Télécharger en Word")
```
